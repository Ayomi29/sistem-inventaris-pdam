...
<body>
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="/">SIRIKO PDAM</a>
        ...
        <div class="navbar-nav">
            <form action="/logout" method="POST">
                ...
                <div class="nav-item text-nowrap">
                    <button type="submit" class="nav-link text-bg-dark px-3 border border-0">Sign Out</button>
                </div>
            </form>
        </div>
    </header>
